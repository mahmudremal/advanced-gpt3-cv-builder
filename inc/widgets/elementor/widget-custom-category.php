...
class Widgets_CustomCategory extends \Elementor\Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		wp_register_style( 'listivo-child-widgets', ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_CSS_URI . '/widgets.css', [], apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/filesystem/filemtime', false, ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_CSS_DIR_PATH . '/widgets.css' ) );

		wp_register_script( 'swiper', site_url( '/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js' ), [], apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/filesystem/filemtime', false, ABSPATH . '/wp-content/plugins/elementor/assets/lib/swiper/swiper.min.js' ), true );

		wp_register_script( 'listivo-child-widgets', ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_JS_URI . '/widgets.js', [ 'swiper' ], apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/filesystem/filemtime', false, ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_JS_DIR_PATH . '/widgets.js' ), true );

	}
advanced-gpt3-cv-builder
	/**
...
advanced-gpt3-cv-builder
		return __( 'Custom Category Slider', 'advanced-gpt3-cv-builder' );
...
advanced-gpt3-cv-builder
	 ...
	 * Used to determine where to display theadvanced-gpt3-cv-builderor.
...
advanced-gpt3-cv-builder
	...
	public function get_categories() advanced-gpt3-cv-builder
...
advanced-gpt3-cv-builder
	...
	public function get_script_depends() advanced-gpt3-cv-builder
...
advanced-gpt3-cv-builder
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			'section_content',advanced-gpt3-cv-builder

			array(

				'label' => __( 'Content', 'advanced-gpt3-cv-builder' ),

			)

		);

		$this->add_control(advanced-gpt3-cv-builder

			'show_view_all',advanced-gpt3-cv-builder

			[

				'label' => esc_html__('Display "View All" button', 'advanced-gpt3-cv-builder'),

				'type' => Controls_Manager::SWITCHER,advanced-gpt3-cv-builder

				'return_value' => '1',advanced-gpt3-cv-builder
		...
		$this->add_control(
			...
			[
advanced-gpt3-cv-builder
				'label' => esc_html__('Style', 'advanced-gpt3-cv-builder'),

				'type' => Controls_Manager::SELECT,

				'options' => [

					'left' => esc_html__('Left', 'advanced-gpt3-cv-builder'),

					'right' => esc_html__('Right', 'advanced-gpt3-cv-builder'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Heading Text', 'advanced-gpt3-cv-builder' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'Heading Text', 'advanced-gpt3-cv-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Show button', 'advanced-gpt3-cv-builder'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('View All Text', 'advanced-gpt3-cv-builder'),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'Button Text', 'advanced-gpt3-cv-builder' ),

				'type'    => Controls_Manager::TEXT,

				'default' => __( 'View all', 'advanced-gpt3-cv-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => __( 'View all button link', 'advanced-gpt3-cv-builder' ),
		...
		$this->add_control(
				...
				[
						...
						'label' => esc_html__('Image', 'advanced-gpt3-cv-builder'),
		...
		$this->start_controls_section(
			...
			array(
				...
				'label' => __( 'Slider', 'advanced-gpt3-cv-builder' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category Label', 'advanced-gpt3-cv-builder'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Title Here', 'advanced-gpt3-cv-builder' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Category URL', 'advanced-gpt3-cv-builder'),

				'type' => Controls_Manager::TEXT,

				'placeholder' => __( 'Full URL of this category.', 'advanced-gpt3-cv-builder' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => esc_html__('Background Color', 'advanced-gpt3-cv-builder'),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__('Category Items', 'advanced-gpt3-cv-builder'),
