...
class Bulks {
	...
	protected function setup_hooks() {
		$this->args = [
			...
			'column'	=> 'status',
			'options'	=> [
				''       => __( 'All', 'advanced-gpt3-cv-builder' ),
				'open'   => __( 'Open', 'advanced-gpt3-cv-builder' ),
				'closed' => __( 'Closed', 'advanced-gpt3-cv-builder' ),
			]
		];
		/**
		 ...
		 */
		add_action( 'wp_ajax_futurewordpress/project/advancedgpt3cvbuilder/status/switch', [ $this, 'ajax_switch' ], 10, 0 );
		add_action( 'wp_ajax_nopriv_futurewordpress/project/advancedgpt3cvbuilder/status/switch', [ $this, 'ajax_switch' ], 10, 0 );
	}
	/**
	...
	public function manage_posts_columns( $columns ) {
		...
		$columns[ $this->args[ 'column' ] ] = __( 'Status', 'advanced-gpt3-cv-builder' );
		return $columns;
	}
	/**
	...
	public function manage_posts_custom_column( $column, $post_id ) {
		if( $this->args[ 'column' ] == $column ) {
			$args = [
				'confirm'	=> true,
				'request'	=> [
					'action'		=> 'futurewordpress/project/advancedgpt3cvbuilder/status/switch',
					'post_id'		=> $post_id,
					'status'		=> false
				]
			];
