...
class Profile {
	...
	protected function setup_hooks() {
		...
		add_filter( 'futurewordpress/project/advancedgpt3cvbuilder/filesystem/set_avater', [ $this, 'set_avater' ], 10, 2 );
		...
		add_filter( 'futurewordpress/project/advancedgpt3cvbuilder/profile/defaulttab', [ $this, 'defaultTab' ], 1, 1 );
	}
    ...
    $redirect_to = apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/user/dashboardpermalink', false, $who );
    return $redirect_to;
	}
	...
	public function woocommerce_get_myaccount_page_permalink( $permalink ) {
		return apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/user/dashboardpermalink', false, 'me' );
	}
	public function woocommerce_account_navigation() {
		if( ! apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/system/isactive', 'dashboard-disablemyaccount' ) ) {return;}
		$link = apply_filters( 'futurewordpress/project/advancedgpt3cvbuilder/user/dashboardpermalink', false, 'me' );
		wp_redirect( $link );
		?>
