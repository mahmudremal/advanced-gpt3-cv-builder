...
$cvTemplates = [
    ...
    'template' => '
      <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 794.08002 1123.36" height="1123.36" width="794.08002" xml:space="preserve" version="1.1" style="background: #fff;">
        ...
        <g transform="matrix(1.3333333,0,0,-1.3333333,0,1123.36)">
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:<%= ( ( cv.info.given_name + cv.info.family_name).length > 10 ) ? 37 : 48 %>px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.95611435,<%= ( ( cv.info.given_name + cv.info.family_name).length > 10 ) ? 10 : 25 %>,760)">
                <%= svg.wrapText( cv.info.given_name + \' \' + cv.info.family_name, 12, \'<tspan x="{{x}}" dy="{{dy}}" text-anchor="start">\', \'</tspan>\', \'1em\', false, {x: \'right\', xsum: 18, xfrom: 230} ) %>
              </text>
            </g>
          </g>
          <g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:9px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.94737,0,0,-1,264.89,749.26)">
                <%= svg.wrapText( \'Office address: \' + cv.info.address, 60, false, false, \'1.5em\' ) %>
                <%= svg.wrapText( \'Musterstadt E-Mail: \' + cv.info.email, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                <%= svg.wrapText( \'Portfolio: \' + cv.info.website, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                <% if( typeof( cv.scl ) !== "undefined" ) { %>
                  <% _.each(cv.scl, function(scl, sclI) { %>
                    <%= svg.wrapText( scl.title + \' \' + scl.user, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                  <% }); %>
                <% } %>
              </text>
            </g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,279.55,645)">
          ...
          <g>
            ...
            <% _.each(cv.edu, function(edu, eduI) { %>
              <g>
                <g>
                  <text style="font-style:italic;font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana-Italic;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,265.13,<%= ( ( ( 620 - svg.objectLength( cv.skl ) * 15 - 70 ) - svg.objectLength( cv.exp ) * 70 - 20 ) - eduI * 70 ) %>)">
                    <%= svg.wrapText( edu.institute, 30, \'<tspan x="0" dy="{{dy}}" style="font-variant:normal;font-weight:bold;font-size:10px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none">\', \'</tspan>\', \'1.5em\' ) %>
                    <%= svg.wrapText( edu.training, 30, false, false, \'1.2em\', \'1.2em\' ) %>
                    <%= svg.wrapText( svg.getDate( edu.from, \'MMMM, YYYY\' ) + \' - \' + svg.getDate( edu.to, \'MMMM DD, YYYY\' ), 27, false, false, \'1.5em\', \'1.5em\' ) %>
                  </text>
                </g>
              </g>
              <g>
          ...
          <% _.each(cv.skl, function(skl, sklI) { %>
            <%= svg.wrapText( skl.title, 45, false, false, \'1.5em\', \'1.5em\' ) %>
            <path style="fill:#000000;fill-opacity:1;fill-rule:evenodd;stroke:none" d="m 267.45,<%= ( 634 - ( sklI * 15 ) ) %> h -0.4 l -0.2,0.05 -1.1,1.25 v 0.4 l 1.3,1.3 h 0.4 l 1.3,-1.5 v -0.2 z"/>
          <% }); %>
  ...
  [
    ...
    'title' => 'Solid BG',
    'fields' => [ 'avater', 'given_name', 'family_name', 'tagline', 'birth', 'nationality', 'residence', 'zivilstand', 'children', 'address', 'phone', 'email', 'website', 'bio', 'edu', 'exp', 'skl', 'inrts', 'lng', 'scl', 'hby', 'ref', 'sact' ],
    'template' => '
      <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 794.08002 1123.36" height="1123.36" width="794.08002" xml:space="preserve" version="1.1">
        <metadata>
          <rdf:RDF>
        ...
        <g transform="matrix(1.3333333,0,0,-1.3333333,0,1123.36)">
          ...
          <g>
            <g clip-path="url(#clipPath404)">
              <text style="font-variant:normal;font-weight:bold;font-size:10.72592354px;font-family:TrebuchetMS;-inkscape-font-specification:TrebuchetMS-Bold;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.92859133,62.304,<%= ( 549 - ( expI * 130 ) ) %>)">
                <%= svg.wrapText( exp.occupation, 45, false, false, \'1.4em\' ) %>
                <%= svg.wrapText( exp.enterprise + \', \' + exp.workplace + \', \' + exp.workload, 45, false, false, \'1.4em\', \'1.4em\' ) %>
