...
<?php do_action( 'futurewordpress/project/advancedgpt3cvbuilder/parts/call', 'before_content' ); ?>
<div class="content-inner container-fluid pb-0" id="page_layout">
    <?php do_action( 'futurewordpress/project/advancedgpt3cvbuilder/admin/notices', 'content' ); ?>
    <?php do_action( 'futurewordpress/project/advancedgpt3cvbuilder/parts/call', 'content' ); ?>
</div>
<?php do_action( 'futurewordpress/project/advancedgpt3cvbuilder/parts/call', 'aft_ercontent' ); ?>
