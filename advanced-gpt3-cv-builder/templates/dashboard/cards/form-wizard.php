...
<div class="card card-full-width">
  ...
  <div class="card-body">
    <form id="register-existing-account-wizard" class="mt-3 text-center" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
      <input type="hidden" name="action" value="futurewordpress/project/advancedgpt3cvbuilder/action/registerexisting" encoding="multipart/form-data">
      <input type="hidden" name="userid" value="<?php echo esc_attr( bin2hex( $userInfo->ID ) ); ?>">
      <?php wp_nonce_field( 'futurewordpress/project/advancedgpt3cvbuilder/verify/registerexisting', '_nonce', true, true ); ?>
      <ul id="top-tab-list" class="p-0 row list-inline">
        <li class="mb-2 col-lg-3 col-md-6 text-start active" id="account">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Account', 'advanced-gpt3-cv-builder' ); ?></span>
          </a>
        </li>
        <li id="social" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Social', 'advanced-gpt3-cv-builder' ); ?></span>
          </a>
        </li>
        <li id="payment" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Payment', 'advanced-gpt3-cv-builder' ); ?></span>
          </a>
        </li>
        <li id="contract" class="mb-2 col-lg-3 col-md-6 text-start">
          <a href="javascript:void(0);">
            ...
            <span class="dark-wizard"><?php esc_html_e( 'Contract', 'advanced-gpt3-cv-builder' ); ?></span>
          </a>
        </li>
      </ul>
      <!-- fieldsets -->
      <fieldset class="active">
        <div class="form-card text-start mb-2">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Account & Personal Information:', 'advanced-gpt3-cv-builder' ); ?></h3>
            </div>
            <!-- <div class="col-5">
              <h2 class="steps mb-4"><?php esc_html_e( 'Step 1 - 4', 'advanced-gpt3-cv-builder' ); ?></h2>
            </div> -->
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Email:', 'advanced-gpt3-cv-builder' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'First Name:', 'advanced-gpt3-cv-builder' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Last Name:', 'advanced-gpt3-cv-builder' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Display Name:', 'advanced-gpt3-cv-builder' ); ?>: *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Password:', 'advanced-gpt3-cv-builder' ); ?> *</label>
            ...
            <div class="col-md-6">
              <div class="form-group my-1">
                <label class="form-label"><?php esc_html_e( 'Confirm Password:', 'advanced-gpt3-cv-builder' ); ?> *</label>
                <div class="input-group has-validation">
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'advanced-gpt3-cv-builder' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Socials & Connection:', 'advanced-gpt3-cv-builder' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 2 - 4', 'advanced-gpt3-cv-builder' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <label class="form-label"><?php esc_html_e( 'TikTok Handle:', 'advanced-gpt3-cv-builder' ); ?></label>
              <div class="form-group input-group">
                  <span class="input-group-text" id="tiktok-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'TikTok Handle:', 'advanced-gpt3-cv-builder' ); ?>" aria-describedby="tiktok-handle" name="metadata[tiktok]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->tiktok ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'YouTube Handle:', 'advanced-gpt3-cv-builder' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="youtube-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'advanced-gpt3-cv-builder' ); ?>" aria-describedby="youtube-handle" name="metadata[YouTube_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->YouTube_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Instagram Handle:', 'advanced-gpt3-cv-builder' ); ?></label>
                <div class="form-group input-group">
                  <span class="input-group-text" id="instagram-handle">@</span>
                  <input type="text" class="form-control" aria-label="<?php esc_attr_e( 'YouTube Handle:', 'advanced-gpt3-cv-builder' ); ?>" aria-describedby="instagram-handle" name="metadata[instagram_url]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->instagram_url ); ?>">
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Website Url:', 'advanced-gpt3-cv-builder' ); ?></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'City:', 'advanced-gpt3-cv-builder' ); ?></label>
                <input type="text" class="form-control" name="metadata[city]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->city ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'State:', 'advanced-gpt3-cv-builder' ); ?></label>
                <input type="text" class="form-control" name="metadata[state]" placeholder="" value="<?php echo esc_attr( $userInfo->meta->state ); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Zip Code:', 'advanced-gpt3-cv-builder' ); ?></label>
        ...
        <button type="button" name="next" class="btn btn-primary next action-button float-end" value="Next"><?php esc_html_e( 'Next', 'advanced-gpt3-cv-builder' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'advanced-gpt3-cv-builder' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card text-start">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4"><?php esc_html_e( 'Payment:', 'advanced-gpt3-cv-builder' ); ?></h3>
              <!-- <h3 class="mb-4"><?php esc_html_e( 'Image Upload:', 'advanced-gpt3-cv-builder' ); ?></h3> -->
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 3 - 4', 'advanced-gpt3-cv-builder' ); ?></h2> -->
            </div>
          </div>
          <div class="row">
                ...
                <div class="card rounded-3">
                  <div class="card-body mx-1 my-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <p class="d-flex flex-column mb-0">
                          <b><?php esc_html_e( 'Pay to proceed on contract.', 'advanced-gpt3-cv-builder' ); ?></b>
                        </p>
                      </div>
                    </div>
                      ...
                      <div class="d-flex flex-row pb-3">
                        <div class="rounded border border-primary border-2 d-flex w-100 p-3 align-items-center"
                          ...
                          <div class="d-flex flex-column">
                            <p class="mb-1 small text-primary"><?php esc_html_e( 'Monthly Retainer', 'advanced-gpt3-cv-builder' ); ?></p>
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-1">
                      <!-- <a href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" class="btn btn-primary btn-lg pay_retainer-amount" target="_blank"><?php esc_html_e( 'Pay amount',   'advanced-gpt3-cv-builder' ); ?></a> -->
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="col-sm-6">
              <div class="form-group">
                <label class="form-label"><?php esc_html_e( 'Upload Your Photo:', 'advanced-gpt3-cv-builder' ); ?></label>
        ...
        <!-- <a type="button" href="<?php echo esc_url( site_url( 'pay_retainer/' . $userInfo->ID . '/' ) ); ?>" target="_blank" name="pay-amount" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Pay Amount', 'advanced-gpt3-cv-builder' ); ?></a> -->
        <button type="submit" name="submit" class="btn btn-primary next action-button float-end" value="Submit"><?php esc_html_e( 'Submit', 'advanced-gpt3-cv-builder' ); ?></button>
        <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous"><?php esc_html_e( 'Previous', 'advanced-gpt3-cv-builder' ); ?></button>
      </fieldset>
      <fieldset class="">
        <div class="form-card">
          <div class="row">
            <div class="col-7">
              <h3 class="mb-4 text-left"><?php esc_html_e( 'Finish:', 'advanced-gpt3-cv-builder' ); ?></h3>
            </div>
            <div class="col-5">
              <!-- <h2 class="steps mb-4"><?php esc_html_e( 'Step 4 - 4', 'advanced-gpt3-cv-builder' ); ?></h2> -->
            </div>
          </div>
          <br>
          <br>
          <h2 class="text-center text-success">
            <strong><?php esc_html_e( 'SUCCESS !', 'advanced-gpt3-cv-builder' ); ?></strong>
          </h2>
          <br>
          <div class="row justify-content-center">
            <div class="col-3">
              <img src="<?php echo esc_url( ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_URI . '/img/img-success.png' ); ?>" class="img-fluid" alt="fit-image" loading="lazy">
            </div>
          </div>
          <br>
          <br>
          <div class="row justify-content-center">
            <div class="text-center col-7">
              <h5 class="text-center purple-text"><?php esc_html_e( 'You Have Successfully Signed Up', 'advanced-gpt3-cv-builder' ); ?></h5>
            </div>
          </div>
        </div>
      </fieldset>
