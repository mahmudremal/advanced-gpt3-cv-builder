<?php
/**
 * ['avater', 'given_name', 'family_name', 'tagline', 'birth', 'nationality', 'residence', 'zivilstand', 'children', 'address', 'phone', 'email', 'website', 'bio', 'edu', 'exp', 'skl', 'inrts', 'lng', 'scl', 'hby', 'ref']
 */

$cvTemplates = [
  [
    'type' => 'one_page',
    'img' =>  esc_url( ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_URI . '/img/template_4.jpg' ),
    'title' => 'One Page',
    'fields' => [
      'avater' => ['min' => 0, 'max' => 1],
      'given_name' => ['min' => 0, 'max' => 10],
      'family_name' => ['min' => 0, 'max' => 10],
    ...
    'template' => '
      ...
      <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 794.08002 1123.36" height="1123.36" width="794.08002" xml:space="preserve" version="1.1">
        ...
        <g transform="matrix(1.3333333,0,0,-1.3333333,0,1123.36)">
          ...
          <g>
            <g clip-path="url(#clipPath100)">
              <text style="font-variant:normal;font-weight:normal;font-size:47.52000046px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#2f2416;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.84906,0,0,-1,50,<%= cv.calc.left %>)">
                <% cv.calc.html = svg.wrapText( cv.info.given_name + \' \' + cv.info.family_name, 12, \'<tspan x="{{x}}" dy="{{dy}}" text-anchor="middle">\', \'</tspan>\', \'1em\', false, {x: \'middle\', xsum: 18, xfrom: 100} ) %>
                <%= cv.calc.html %>
              </text>
            </g>
          </g>
          ...
          <% if( ! svg.is_empty( cv.info.phone ) ) { %>
          <g>
            <g clip-path="url(#clipPath1648)">
              <text style="font-variant:normal;font-weight:normal;font-size:9.96000004px;font-family:Tahoma;-inkscape-font-specification:Tahoma;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.94595,0,0,-1,41.28,<%= cv.calc.left %>)"><tspan y="0" x="0"><%= i18n?.tel__??\'Tel:\' %></tspan></text>
            </g>
          </g>
          <g>
          ...
          <% } %>
          <% if( ! svg.is_empty( cv.info.email ) ) { %>
            <% cv.calc.left = ( cv.calc.left - 13 ) %>
            <g>
              <g clip-path="url(#clipPath1668)">
                <text style="font-variant:normal;font-weight:normal;font-size:9.96000004px;font-family:Tahoma;-inkscape-font-specification:Tahoma;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.78378,0,0,-1,41.28,<%= cv.calc.left %>)"><tspan y="0" x="0"><%= i18n?.email__??\'Email:\' %></tspan></text>
              </g>
            </g>
            <g>
          ...
          <% } %>
          <% if( ! svg.is_empty( cv.info.address ) ) { %>
            <% cv.calc.left = ( cv.calc.left - 13 ) %>
            <g>
              <g clip-path="url(#clipPath1708)">
                <text style="font-variant:normal;font-weight:normal;font-size:9.96000004px;font-family:Tahoma;-inkscape-font-specification:Tahoma;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,41.28,<%= cv.calc.left %>)"><tspan y="0" x="0"><%= i18n?.address__??\'Address:\' %></tspan></text>
              </g>
            </g>
            <g>
            ...
            <g>
              <g clip-path="url(#clipPath1956)">
                <text style="font-variant:normal;font-weight:normal;font-size:9.96000004px;font-family:Tahoma;-inkscape-font-specification:Tahoma;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89189,0,0,-1,41.28,<%= cv.calc.left %>)">
                  <tspan y="0" x="0"><%= i18n?.birthday__??\'Birthday:\' %></tspan>
                </text>
              </g>
            </g>
            <g>
          ...
          <% _.each(cv.edu, function(edu, eduI) { %>
            ...
            <% cv.calc.right = ( cv.calc.right - svg.wrapTextLength( cv.calc.html ) * 15 ) %>
          <% }); %>
          ...
          <g>
            <g clip-path="url(#clipPath824)">
              <text style="font-variant:normal;font-weight:normal;font-size:30.95999908px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,330.67,<%= cv.calc.right %>)">
                <%= svg.wrapText( i18n?.professional_experience??\'Professional experience\', 15, false, false, \'1em\' ) %>
              </text>
            </g>
          </g>
          ...
          <g>
            <g clip-path="url(#clipPath1532)">
              <text style="font-variant:normal;font-weight:normal;font-size:30.95999908px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,330.67,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.abilities??\'Abilities\' %></tspan>
              </text>
            </g>
          </g>
          ...
          <g>
            <g clip-path="url(#clipPath1928)">
              <text style="font-variant:normal;font-weight:normal;font-size:30.95999908px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,330.55,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.languages??\'Languages\' %></tspan>
              </text>
            </g>
          </g>
  ...
  [
    'type' => 'no_img',
    'img' =>  esc_url( ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_URI . '/img/template_5.jpg' ),
    'title' => 'No Image',
    'fields' => [
      'given_name' => ['min' => 0, 'max' => 10],
      'family_name' => ['min' => 0, 'max' => 10],
      'tagline' => ['min' => 0, 'max' => 100],
      'address' => ['min' => 0, 'max' => 120],
      'email' => ['min' => 0, 'max' => 100],
    ...
    'template' => '
      ...
      <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 794.08002 1123.36" height="1123.36" width="794.08002" xml:space="preserve" version="1.1" style="background: #fff;">
        ...
        <g transform="matrix(1.3333333,0,0,-1.3333333,0,1123.36)">
          ...
          <% cv.calc.mxLeft = ( cv.info.given_name.length >= cv.info.family_name.length ) ? cv.info.given_name : cv.info.family_name %>
          <% cv.calc.toLeft = ( 230 - ( cv.calc.mxLeft.length * 20 ) - 10 ) %>
          <% cv.calc.toLeft = 15 %>
          <% cv.calc.fontSize = ( ( cv.info.given_name + cv.info.family_name).length > 10 ) ? 35 : 35 %>
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:<%= cv.calc.fontSize %>px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.95611435,<%= cv.calc.toLeft %>,<%= cv.calc.left %>)">
              <% cv.calc.html = svg.wrapText( cv.info.given_name, 12, \'<tspan x="{{x}}" dy="{{dy}}" text-anchor="start">\', \'</tspan>\', \'1em\', false, {x: \'right\', xsum: 17.5556, xfrom: 200} ) %>
              <% cv.calc.html += svg.wrapText( cv.info.family_name, 12, \'<tspan x="{{x}}" dy="{{dy}}" text-anchor="start">\', \'</tspan>\', \'1em\', \'1em\', {x: \'right\', xsum: 17.5556, xfrom: 200} ) %><%= cv.calc.html %>
              </text>
            </g>
          </g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.84848,0,0,-1,85,<%= cv.calc.left %>)">
                <tspan y="0" x="0"><%= i18n?.personal_details??\'Personal details\' %></tspan>
              </text>
            </g>
          </g>
          ...
          <% if( svg.objectLength( cv.ref ) >= 1 ) { %>
            <g>
              <g>
                <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.84848,0,0,-1,85,<%= cv.calc.left %>)">
                  <tspan y="0" x="0"><%= i18n?.arbeitsreferenzen??\'Arbeitsreferenzen\' %></tspan>
                </text>
              </g>
            </g>
            ...
            <g>
              <g>
                <text style="font-variant:normal;font-weight:bold;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.93023,0,0,-1,85,<%= cv.calc.left %>)">
            ...
            <g>
              <g>
                <text style="font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,85,<%= cv.calc.left %>)">
                  <% cv.calc.html = svg.wrapText( ref.position, 35, false, false, \'1.4em\' ) + svg.wrapText( i18n?.email__??\'Email:\' + \' \' + ref.email, 35, false, false, \'1.4em\', \'1.4em\' ) %>
                  <%= cv.calc.html %>
                </text>
              </g>
            </g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,264.89,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.contact_details??\'Contact details\' %></tspan>
              </text>
            </g>
          </g>
          <g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:9px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.94737,0,0,-1,264.89,<%= cv.calc.right %>)">
                <% cv.calc.html = svg.is_empty( cv.info.address ) ? \'\' : svg.wrapText( \'Office address: \' + cv.info.address, 60, false, false, \'1.5em\' ) %>
                <% cv.calc.html += svg.is_empty( cv.info.email ) ? \'\' : svg.wrapText( \'Musterstadt E-Mail: \' + cv.info.email, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                <% cv.calc.html += svg.is_empty( cv.info.website ) ? \'\' : svg.wrapText( \'Portfolio: \' + cv.info.website, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                <% if( svg.objectLength( cv.scl ) >= 1 ) { %>
                  <% _.each(cv.scl, function(scl, sclI) { %>
                    <% cv.calc.html += svg.is_empty( scl.user ) ? \'\' : svg.wrapText( scl.title + \': \' + scl.user, 60, false, false, \'1.5em\', \'1.5em\' ) %>
                  <% }); %>
                <% } %>
                <%= cv.calc.html %>
              </text>
          ...
          <% if( svg.objectLength( cv.skl ) >= 1 ) { %>
            <g>
              <g>
                <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-1,264.89,<%= cv.calc.right %>)">
                  <tspan y="0" x="0"><%= i18n?.competencies??\'Competencies\' %></tspan>
                </text>
              </g>
            </g>
          ...
          <g>
            <g>
              <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.84848,0,0,-1,265.01,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.professional_career??\'Professional career\' %></tspan>
              </text>
            </g>
          </g>
          <% cv.calc.right = ( cv.calc.right - 25 ) %>
            <% _.each(cv.exp, function(exp, expI) { %>
              <g>
                <g>
                  <text style="font-variant:normal;font-weight:bold;font-size:9px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,265.01,<%= cv.calc.right %>)">
                    <% cv.calc.htmlLeft = svg.wrapText( exp.occupation, 20, false, false, \'1.3em\' ) %><%= cv.calc.htmlLeft %>
                    <% cv.calc.rightLeft = cv.calc.rightTitle = ( svg.wrapTextLength( cv.calc.htmlLeft ) * 10 + 5 ) %>
                  </text>
                </g>
              </g>
              <g>
              ...
              <% cv.calc.path = ( svg.is_empty( exp.desc ) ) ? \'\' : \'<path style="fill:#000000;fill-opacity:1;fill-rule:evenodd;stroke:none" d="m 384.2,\' + cv.calc.right + \' h -0.4 l -0.2,0.05 -1.1,1.25 v 0.4 l 1.3,1.3 h 0.4 l 1.3,-1.5 v -0.2 z"/>\' %>
              <% cv.calc.right = ( cv.calc.right - cv.calc.rightTitle ) %>
              <g>
                <g>
                  <text style="font-style:italic;font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana-Italic;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,265.01,<%= cv.calc.right %>)">
                    <% cv.calc.htmlLeft = svg.wrapText( exp.enterprise + \', \' + exp.workplace, 50, false, false, \'1.2em\' ) %>
                    <%= cv.calc.htmlLeft %>
                    <% cv.calc.rightLeft = ( cv.calc.rightLeft + svg.wrapTextLength( cv.calc.htmlLeft ) * 10 ) %>
                    <% cv.calc.htmlLeft = svg.wrapText( exp.from + \' to \' + exp.to, 30, false, false, \'1.2em\', \'1.2em\' ) %>
                    <%= cv.calc.htmlLeft %>
                    <% cv.calc.rightLeft = ( cv.calc.rightLeft + svg.wrapTextLength( cv.calc.htmlLeft ) * 10 ) %>
                  </text>
                </g>
              ...
              <% cv.calc.rightDesc = ( svg.wrapTextLength( cv.calc.htmlDesc ) * 10 ) %>
              <% cv.calc.rightLeft = ( cv.calc.rightLeft - cv.calc.rightTitle ) %>
              <% cv.calc.rightBig = ( ( cv.calc.rightLeft >= cv.calc.rightDesc ) ? cv.calc.rightLeft : cv.calc.rightDesc ) %>
              <% cv.calc.right = ( cv.calc.right - cv.calc.rightBig - 20 ) %>
            <% }); %>
          <% } %>
          <% cv.calc.right = ( cv.calc.right - 10 ) %>
          <% if( svg.objectLength( cv.edu ) >= 1 ) { %>
            <g>
              <g>
                <text style="font-variant:normal;font-weight:bold;font-size:14.03999996px;font-family:Verdana;-inkscape-font-specification:Verdana-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89394,0,0,-1,265.01,<%= cv.calc.right %>)">
                  <tspan y="0" x="0"><%= i18n?.academic_career??\'Academic career\' %></tspan>
                </text>
              </g>
            </g>
            <% cv.calc.right = ( cv.calc.right - 30 ) %>
              ...
              <g>
                <g>
                  <text style="font-style:italic;font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana-Italic;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,265.13,<%= cv.calc.right %>)">
                    <% cv.calc.htmlLeft = svg.wrapText( edu.institute, 30, \'<tspan x="0" dy="{{dy}}" style="font-variant:normal;font-weight:bold;font-size:10px;font-family:Tahoma;-inkscape-font-specification:Tahoma-Bold;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none">\', \'</tspan>\', \'1.3em\' ) %><%= cv.calc.htmlLeft %>
                    <% cv.calc.rightLeft = ( svg.wrapTextLength( cv.calc.htmlLeft ) * 10 ) %>
                    <% cv.calc.htmlLeft = svg.wrapText( edu.training, 30, false, false, \'1.2em\', \'1.2em\' ) %><%= cv.calc.htmlLeft %>
                    <% cv.calc.rightLeft = ( cv.calc.rightLeft + svg.wrapTextLength( cv.calc.htmlLeft ) * 10 ) %>
                    <% cv.calc.htmlLeft = svg.wrapText( svg.getDate( edu.from, \'MMMM, YYYY\' ) + \' - \' + svg.getDate( edu.to, \'MMMM DD, YYYY\' ), 27, false, false, \'1.5em\', \'1.5em\' ) %>
                    <% cv.calc.rightLeft = ( cv.calc.rightLeft + svg.wrapTextLength( cv.calc.htmlLeft ) * 10 ) %><%= cv.calc.htmlLeft %>
                  </text>
                </g>
              </g>
              <g>
                <g>
                  <text style="font-variant:normal;font-weight:normal;font-size:9px;font-family:Verdana;-inkscape-font-specification:Verdana;writing-mode:lr-tb;fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(0.89474,0,0,-1,381.79,<%= cv.calc.right %>)">
                    <% cv.calc.htmlDesc = svg.wrapText( edu.desc, 50, false, false, \'1.2em\' ) %>
                    <%= cv.calc.htmlDesc %>
                  </text>
                </g>
              </g>
  ...
  [
    'type' => 'solid_bg',
    'img' =>  esc_url( ADVANCEDGPT3CVBUILDER_PROJECT_BUILD_URI . '/img/template_6.jpg' ),
    'title' => 'Solid BG',
    'fields' => [
      'avater' => ['min' => 0, 'max' => 1],
      'given_name' => ['min' => 0, 'max' => 12],
      'family_name' => ['min' => 0, 'max' => 12],
      'phone' => ['min' => 0, 'max' => 100],
      'email' => ['min' => 0, 'max' => 100],
      'website' => ['min' => 0, 'max' => 100],
      'bio' => ['min' => 0, 'max' => 350],
    ...
    'template' => '
      ...
      <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 794.08002 1123.36" height="1123.36" width="794.08002" xml:space="preserve" version="1.1">
        ...
        <g transform="matrix(1.3333333,0,0,-1.3333333,0,1123.36)">
          ...
          <g>
            <g clip-path="url(#clipPath56)">
              <text style="font-variant:normal;font-weight:normal;font-size:50.63278961px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.86979212,35.88,<%= cv.calc.top %>)">
                <% cv.calc.html = svg.wrapText( cv.info.given_name + \' \' + cv.info.family_name, 14, false, false, \'1em\' ) %><%= cv.calc.html %>
              </text>
            </g>
          </g>
          ...
          <% cv.calc.top = ( cv.calc.top <= 640 ) ? cv.calc.top : 640 %>
          <g>
          ...
          <g>
            <g clip-path="url(#clipPath348)">
              <text style="font-variant:normal;font-weight:normal;font-size:18.06831551px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.88331419,35.16,<%= cv.calc.left %>)">
                <tspan y="0" x="0"><%= i18n?.work_experience??\'Work experience\' %></tspan>
              </text>
            </g>
          </g>
          ...
          <g>
            <g clip-path="url(#clipPath1620)">
              <text style="font-variant:normal;font-weight:normal;font-size:17.46502876px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.91382619,35.16,<%= cv.calc.left %>)">
                <tspan y="0" x="0"><%= i18n?.skills_and_knowledge??\'Skills and knowledge\' %></tspan>
              </text>
            </g>
          </g>
          ...
          <g>
            <g clip-path="url(#clipPath368)">
              <text style="font-variant:normal;font-weight:normal;font-size:17.46502876px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.91382619,321.43,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.my_education??\'My education\' %></tspan>
              </text>
            </g>
          </g>
          ...
          <% }); %>
          <% cv.calc.right = ( cv.calc.right - 5 - svg.wrapTextLength( cv.calc.html ) * 14 ) %>
          ...
          <g>
            <g clip-path="url(#clipPath1316)">
              <text style="font-variant:normal;font-weight:normal;font-size:18.06831551px;font-family:TimesNewRomanPSMT;-inkscape-font-specification:TimesNewRomanPSMT;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.88331419,323.11,<%= cv.calc.right %>)">
                <tspan y="0" x="0"><%= i18n?.volunteering??\'Volunteering\' %></tspan>
              </text>
            </g>
          </g>
          <% cv.calc.topoint = cv.calc.right = ( cv.calc.right - 20 ) %><% cv.calc.html = \'\' %>
            ...
            <g>
              <g clip-path="url(#clipPath1336)">
                <text style="font-variant:normal;font-weight:bold;font-size:9.73596001px;font-family:TrebuchetMS;-inkscape-font-specification:TrebuchetMS-Bold;writing-mode:lr-tb;fill:#4d4a44;fill-opacity:1;fill-rule:nonzero;stroke:none" transform="matrix(1,0,0,-0.97370983,347.23,<%= cv.calc.right %>)">
                  <% cv.calc.html = svg.wrapText( sact.title, 50, false, false, \'1.4em\' ) %><%= cv.calc.html %>
                </text>
              </g>
            </g>
          ...
          <% }); %>
          <% cv.calc.right = ( cv.calc.right - svg.wrapTextLength( cv.calc.html ) * 14 ) %>
          <% cv.calc.right = ( cv.calc.right <= 65 ) ? 65 : cv.calc.right %>
