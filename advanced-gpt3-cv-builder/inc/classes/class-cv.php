...
class Cv {
	...
	public function cvTemplates() {
		...
		if( ! is_wp_error( $has_meta ) ) {
			...
			$args[ 'cvtitle' ] = get_the_title( $post_id );
			$args[ 'tools' ] = [
				'templates' => $cvTemplates,
				'fonts' => [
					['title' => 'Montserrat','font' => "'Montserrat', sans-serif",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=Montserrat', 'compress' => 1, 'height' => 1],
					['title' => 'Lora','font' => "'Lora', serif",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=Lora', 'compress' => 0.9, 'height' => 1],
					['title' => 'Open Sans','font' => "'Open Sans', sans-serif",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=Open+Sans', 'compress' => 0.95, 'height' => 1],
					['title' => 'Roboto Slab','font' => "'Roboto Slab', serif",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=Roboto+Slab', 'compress' => 0.95, 'height' => 1],
					['title' => 'EB Garamond','font' => "'EB Garamond', serif",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=EB+Garamond', 'compress' => 0.85, 'height' => 1],
					['title' => 'Great Vibes','font' => "'Great Vibes', cursive",'weights' => [],'url' => 'https://fonts.googleapis.com/css?family=Great+Vibes', 'compress' => 0.8, 'height' => 1.3],
					['title' => 'Raleway','font' => "'Raleway', sans-serif",'weights' => ['bold'],'url' => 'https://fonts.googleapis.com/css?family=Raleway', 'compress' => 0.95, 'height' => 1.1],
				],
				'fontsizes' => [
					['title' => 'XXL','size' => 1.75],
					['title' => 'XL','size' => 1.5],
	...
	public function cvCreate() {
		...
		$return = wp_insert_post( [
			'post_title'    => ( isset( $_POST[ 'title' ] ) && ! empty( $_POST[ 'title' ] ) ) ? $_POST[ 'title' ] : __( 'My Resume', 'advanced-gpt3-cv-builder' ),
			'post_content'  => '',
			'post_status'   => 'publish',
			'post_type'   	=> 'resume',
