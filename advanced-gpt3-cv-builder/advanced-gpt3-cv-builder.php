 ...
 * Description:       CV Builder Plugin by FutureWordPress - a tool for creating professional resumes! Simply add the "create-new-cv" class to create a button that generates your CV. If you prefer a simpler design, you can add "no-progress-here" class to omit the progress SVG. This plugin streamlines the job application process with a polished and well-crafted CV.
 * Version:           1.0.2
